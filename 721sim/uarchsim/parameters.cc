...
uint64_t SVP_Q_SIZE = 256;
bool SVP_ORACLE_CONF = false;
uint64_t SVP_INDEX_BITS = 10;
uint64_t SVP_TAG_BITS = 20;
uint64_t SVP_CONF_MAX = 3;
bool VP_PRED_INT_ALU = true;
...
bool STORE_SETS = false;
bool ALWAYS_PREDICT_CONFLICT = false;
bool ORACLE_MDP = false;
